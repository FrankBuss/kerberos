...
SST39V1681_NUM_BANKS     = 64
SST39V1681_MFR_ID        = $bf
SST39V1681_DEV_ID        = $c8
...
; Internal function
;
; Select first 1 mb of flash memory.
;
; Parameters:
;
; Changes:
...
; Internal function
;
; Select second 1 mb of flash memory.
;
; Parameters:
;
; Changes:
...
ciNoRamError:
        ...
        ; check if it is an SST39V1681
        cpx #SST39V1681_MFR_ID
        bne ciNotSupported
        cmp #SST39V1681_DEV_ID
        bne ciNotSupported
...
returnOnly:                     ; C indicates error
        ...
        ldy #SST39V1681_NUM_BANKS ; number of banks in Y
